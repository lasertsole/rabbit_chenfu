<template>
    <el-dialog class="newWorkModelBox"
        ...
        <div class="modelContent">
            ...
            <div class="left">
                <template v-if="table=='showcase'">
                    <p><el-image :preview-src-list="[ServerPath+imgArr]" :src="ServerPath+imgArr"/></p>
                ...
                <template v-else-if="table=='require'">
                    ...
                    <div><el-image :preview-src-list="[ServerPath+imgArr]" :src="ServerPath+imgArr" class="LazyloadImg" v-if="imgArr"/></div>
                    <div class="tail">
            ...
            <div class="right">
                <img :src="author_id==userinfo?.id?ServerPath+userinfo.profile:ServerPath+author_profile"/>
...
<script setup>
    ...
    const { showModel, table, author_id, author_name, author_profile, recomment, imgArr, title, price, sold_num, requireTail} = storeToRefs(detailPage);//控制模态框开关
